...
HANDLER_MAP = {
    ...
    "whisper_subtitle": "features/ai/whisper_subtitle_qt_app.py",
    "esrgan_upscale": "features/ai/upscale_qt_app.py",
    "rmbg_background": "features/ai/bg_removal_qt_app.py",
    "marigold_pbr": "features/ai/marigold_pbr_qt_app.py",
    "gemini_image_tool": "features/ai/standalone/gemini_img_tools.py",
    "demucs_stems": "features/audio/separate_console.py",
    ...
    "extract_bgm": "features/audio/separate_console.py",
    "extract_voice": "features/audio/separate_console.py",
