...
def _pick_targets():
    ...
    try:
        import flet as ft
        # In a real environment, we might use a Flet-based picker if no args
        # But for now, we follow the established pattern of returning args or empty
        return []
    except Exception:
        return []
