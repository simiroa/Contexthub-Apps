...
class OutputOptions:
    ...
    file_prefix: str = "marigold_pbr"
    open_folder_after_run: bool = True
    export_session_json: bool = True


@dataclass
class MarigoldPBRState:
    workflow_name: str = "Balanced"
    workflow_description: str = "Balanced speed and quality (20 steps, 3 ensemble passes)."
