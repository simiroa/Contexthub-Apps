...
class WhisperSubtitleWindow(QMainWindow):
    ...
    def _build_left_panel(self) -> QWidget:
        ...
        self.clear_btn = QPushButton(qt_t("whisper_subtitle.clear", "Clear"))
    ...
    def _build_editor_panel(self) -> QWidget:
        ...
        self.refresh_raw_btn = QPushButton(qt_t("whisper_subtitle.refresh", "Refresh"))
        self.refresh_raw_btn.setObjectName("pillBtn")
        self.apply_raw_btn = QPushButton(qt_t("whisper_subtitle.apply", "Apply"))
        self.apply_raw_btn.setObjectName("pillBtn")
    ...
    def _build_right_panel(self) -> QWidget:
        ...
        self.cancel_btn = QPushButton(qt_t("whisper_subtitle.cancel", "Cancel"))
        self.cancel_btn.setObjectName("pillBtn")
